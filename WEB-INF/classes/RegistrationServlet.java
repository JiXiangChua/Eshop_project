...
@WebServlet("/registration")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class RegistrationServlet extends HttpServlet {
   ...
   //<!-- Start Main Top -->
      ...
      try (
         ...
         /*out.println(cardtype[0]);
         out.println(name[0]);
         out.println(creditCardNo[0]);
         out.println(expiration[0]);
         out.println(cvv[0]);
         out.println(orderID[0]);*/

         // for debugging
         //out.println(username+password);
         //out.println(firstName+lastName+email+address+postal);
         ...
         out.println("<table "
          ...
          +"<div class=\"container\">"
                      +"<div class=\"row\">"
                          +"<div class=\"col-md-12\">"
                            +"<center><h1 class=\"m-b-20\"><strong><br>Hello New Customer:  "+firstName+" "+lastName+",</strong><br><br></h1><center>"
                              +"<center><h3 class=\"m-b-20\"><strong><br>Thank you for registering with us! Return back to payment to login into your account and confirm your order.</strong><br><br></h3><center>"
                                  +"<p><a class=\"btn hvr-hover\" href=\"#\" onclick=\"history.go(-1)\">Back To Login</a></p></p>"
                          +"</div>"
                      +"</div>"
                  +"</div>"
              +"</li>"
  ...
  +"</div>"
      ...
      +"</table>");
         ...
         //Step 3:
         String sqlCustomerDetails = "INSERT INTO billing_address (firstName, lastName, email, country, address, postal, username, password) VALUES ("
                     + "'" + firstName + "'" + ", " + "'" + lastName + "'" + ", " + "'" + email + "'" + ", " + "'" + country + "'" + ", "+ "'" + address + "'" + ", " 
                     + postal + ", " + "'" + username + "'" + ", " + "'" + password+"')";
         ...
         String sqlCreateNewCustomer = "INSERT INTO login (username, password) VALUES ('" + username + "'" + ", " + "'" + password+"')";
         //out.println("<p>" + sqlCreateNewCustomer + "</p>");  // for debugging
         int countCreateCustInserted = stmt.executeUpdate(sqlCreateNewCustomer);
         //out.println(countCreateCustInserted + " records inserted.");
