...
@WebServlet("/buyNowPayment")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
...
// Step 3 & 4: Execute a SQL SELECT query and Process the query result
    ...
    out.println("<div class=\"cart-box-main\">"
                    ...
                    +"<form class=\"mt-3 collapse review-form-box\" method=\"get\" action=\"registration\"id=\"formRegister\">"
                        ...
                        +"<div class=\"form-row\">"
                            ...
                            +"<div class=\"form-group col-md-6\">"
                                ...
                                +"<input type=\"text\" class=\"form-control\" name=\"postal\" maxlength=\"6\" id=\"InputPostal\" placeholder=\"6 digits\" required> </div>"
                        ...
                        +"<form class=\"needs-validation\" novalidate>"
                            ...
                            +"<div class=\"row\">"
                                ...
                                +"<div class=\"col-md-4 mb-3\">"
                                    ...
                                    +"<input type=\"text\" class=\"form-control\" maxlength=\"6\" name=\"postal\"form=\"ToOrder\""
                            ...
                            +"<div class=\"d-block my-3\">"
                                +"<div class=\"custom-control custom-radio\">"
                                    +"<input id=\"credit\" name=\"paymentMethod\" type=\"radio\" class=\"custom-control-input\" form=\"ToOrder\" checked required>"
                                    +"<label class=\"custom-control-label\" for=\"credit\">Credit card</label>"
                                +"</div>"
                                +"<div class=\"custom-control custom-radio\">"
                                    +"<input id=\"debit\" name=\"paymentMethod\" type=\"radio\" class=\"custom-control-input\" form=\"ToOrder\" required>"
                                    +"<label class=\"custom-control-label\" for=\"debit\">Debit card</label>"
                                +"</div>"
                                +"<div class=\"custom-control custom-radio\">"
                                    +"<input id=\"paypal\" name=\"paymentMethod\" type=\"radio\" class=\"custom-control-input\" form=\"ToOrder\" required>"
                            ...
                            +"<div class=\"row\">"
                                +"<div class=\"col-md-6 mb-3\">"
                                    ...
                                    +"<input type=\"text\" class=\"form-control\" id=\"cc-name\" placeholder=\"\" form=\"ToOrder\" required> <small class=\"text-muted\">Full name as displayed on card</small>"
                                    +"<div class=\"invalid-feedback\"> Name on card is required </div>"
                                +"</div>"
                                +"<div class=\"col-md-6 mb-3\">"
                                    +"<label for=\"cc-number\">Credit card number</label>"
                                    +"<input type=\"text\" class=\"form-control\" maxlength=\"16\" id=\"cc-number\" placeholder=\"\" form=\"ToOrder\" required>"
                            ...
                            +"<div class=\"row\">"
                                +"<div class=\"col-md-6 mb-3\">"
                                    ...
                                    +"<input type=\"month\" class=\"form-control\" id=\"cc-expiration\" placeholder=\"\" form=\"ToOrder\" required>"
                                    +"<div class=\"invalid-feedback\"> Expiration date required </div>"
                                +"</div>"
                                +"<div class=\"col-md-3 mb-3\">"
                                    +"<label for=\"cc-expiration\">CVV</label>"
                                    +"<input type=\"text\" class=\"form-control\" maxlength=\"3\" id=\"cc-cvv\" placeholder=\"\" form=\"ToOrder\" required>"
        ...
        /*String sqlGetShoeDetails = "Select * from myCart, shoe where myCart.SID = shoe.SID";
        sqlGetShoeDetails += " ";
        ...
        */
        ...
        /*while(returnShoeDetails.next()){
            if (returnShoeDetails.next() == false){
                out.println("<h3>Your cart is empty</h3>");
            }
            else{*/
                out.println("<div class=\"rounded p-2 bg-light\">"
                                    +"<div class=\"media mb-2 border-bottom\">"
                                    +"<input type=\"hidden\" name='cartItems' value= '"+ShoeSIDDetails[0]+"' form=\"ToOrder\"/>"
                                    +"<input type=\"hidden\" name='cartShoeSize' value= '"+Options[0]+"' form=\"ToOrder\"/>"
                                    +"<input type=\"hidden\" name='cartShoeQuantity' value= '"+Quan[0]+"' form=\"ToOrder\"/>"
                                    +"<input type=\"hidden\" name='cartItems' value= '"+ShoeSIDDetails[0]+"' form=\"formLogin\"/>"
                                    +"<input type=\"hidden\" name='cartShoeSize' value= '"+Options[0]+"' form=\"formLogin\"/>"
                                    +"<input type=\"hidden\" name='cartShoeQuantity' value= '"+Quan[0]+"' form=\"formLogin\"/>"
                                    +"<input type=\"hidden\" name='cartItems' value= '"+ShoeSIDDetails[0]+"' form=\"formRegister\"/>"
                                    +"<input type=\"hidden\" name='cartShoeSize' value= '"+Options[0]+"' form=\"formRegister\"/>"
                                    +"<input type=\"hidden\" name='cartShoeQuantity' value= '"+Quan[0]+"' form=\"formRegister\"/>"
                                    +"<input type=\"hidden\" name='orderid' value= '"+orderID[0]+"' form=\"ToOrder\"/>"
                                    +"<input type=\"hidden\" name='orderid' value= '"+orderID[0]+"' form=\"formLogin\"/>"
                                    +"<input type=\"hidden\" name='orderid' value= '"+orderID[0]+"' form=\"formRegister\"/>"
                                        +"<div class=\"media-body\"> <a href=\"\">"+ModelID[0]+"</a>"
                                            +"<div class=\"small text-muted\">Price: $"+AmountDetails[0]+" <span class=\"mx-2\">|</span>Size: "+Options[0]+"<span class=\"mx-2\">|</span> Qty: "+Quan[0]); 
                                            totalAmountForShoe = Integer.parseInt(AmountDetails[0])*Integer.parseInt(Quan[0]);
